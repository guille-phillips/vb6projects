        ...
        Case 1 ' Keyword
            Select Case LCase$(oExpression.Text)
                Case "list"
                    ListDefinitions
                Case "help"
                    InsertText vbCrLf & "SIN, COS, TAN, EXP, LOG, DEG, RAD, INT, FRAC, SQR, NOT, ATN, ACS, ASN, GAM, COT, CSC, SEC, DMS, LEN, BASE, LOG, FIX, IF, AND, OR, XOR, MOD, LOOP, SHOW" & vbCrLf & "function(x):=func(x)" & vbCrLf & "loop/show+*(a,b) x:x"
            End Select
