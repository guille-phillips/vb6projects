Attribute VB_Name = "Processor6502Test"
Option Explicit
...
Private mbResetSystemVia As Boolean
...
Public Sub Execute()
    ...
    Wend
    Controller.ProcessorStopped StopReason
End Sub
